...
./Lispworks-6-1-0-macos64-universal -init /Volumes/My\ Passport\ for\ Mac/projects/lispworks/VTuning/crypto/tools/deliver-alt-encrypt-lib.lisp
popd
|#
...
(load "VTuning/crypto/tools/alt-encrypt-library")

(deliver 'ecc-crypto-b571::delivered-encrypt-lib
         "alt-encrypt-lib"
         1
         :multiprocessing t
         :console t
...
#|
alt-encrypt-lib VTuning/crypto/tools/encryption.lisp VTuning/crypto/tools/junkx HowdyDave\!
alt-decrypt-lib VTuning/crypto/tools/junkx VTuning/crypto/tools/junkxx HowdyDave\!
|#
