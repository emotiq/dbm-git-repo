...
./Lispworks-6-1-0-macos64-universal -build /Volumes/My\ Passport\ for\ Mac/projects/Lispworks/VTuning/crypto/tools/deliver-escrow.lisp
popd
...
(asdf "panel-items")
(asdf "ecc-decrypt")
(load "VTuning/crypto/tools/master-keys-3ctr")
(load "VTuning/crypto/tools/escrow-intf")
...
(deliver 'ecc-crypto-b571::make-escrow-intf 
	 ...
	 :versioninfo
	  ...
	  :product-name   "Acudora-Escrow"
	  :file-description "Use to decrypt escrow master key"
          :legal-copyright  "Copyright (c) 2012-2013 by Acudora, Inc. All rights reserved.")
	 ;; :keep-debug-mode t
