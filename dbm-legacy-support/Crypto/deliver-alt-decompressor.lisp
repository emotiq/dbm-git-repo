...
./Lispworks-6-1-0-macos64-universal -init /Volumes/My\ Passport\ for\ Mac/projects/lispworks/VTuning/crypto/tools/deliver-alt-decompressor.lisp
popd
|#
...
;; (asdf "ecc-decrypt")
(asdf "alt-decompressor")

(deliver 'delivered-alt-decompressor
         "alt-decompressor"
         5
         ;; :multiprocessing t
         :console t
