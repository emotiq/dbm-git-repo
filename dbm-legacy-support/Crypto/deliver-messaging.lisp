...
./Lispworks-6-0-0-macos64-universal -build ~/projects/lispworks/VTuning/crypto/tools/deliver-messaging.lisp
popd
...
(deliver 'ecc-crypto-b571::make-messaging-intf

         #+:MACOSX
         (let ((this-dir (translate-logical-pathname "PROJECTS:LISP;VTuning;crypto;tools;")))
           (write-macos-application-bundle
            "/Applications/Acudora ECC Messaging.app"
            :signature  "ACUD"
            :identifier "com.acudora.ecc-ibe-messaging"
            :application-icns (merge-pathnames "calculator.icns" this-dir)
            :document-types nil))

	 #+:WIN32 "Acudora ECC Messaging.exe"
